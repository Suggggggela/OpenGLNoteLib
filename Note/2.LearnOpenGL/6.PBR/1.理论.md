...
![654x137](assets/1.理论_image_3.png)
...
![447x294](assets/1.理论_image_4.png)
...
![492x82](assets/1.理论_image_5.png)
...
![574x343](assets/1.理论_image_6.png)
...
对于不同的波段，390nm~700nm范围的光被我们称为可见光
        下图是日光中不同波段光的能量示意图：
![395x261](assets/1.理论_image_7.png)
...
**Solid angle - 立体角**
            ...
            ![309x228](assets/1.理论_image_8.png)
...
**Radiant intensity - 辐射强度**
            ...
            ![320x309](assets/1.理论_image_9.png)
            描述radiant intensity的方程如下：
            ![83x53](assets/1.理论_image_10.png)
            其中I就是立体角上的Radiant intensity

在了解了上边这些概念之后，我们就可以讨论Radiance的方程了：
![183x62](assets/1.理论_image_11.png)
![359x311](assets/1.理论_image_12.png)
...
![420x70](assets/1.理论_image_13.png)
![468x276](assets/1.理论_image_14.png)
...
![349x259](assets/1.理论_image_15.png)
...
![1.理论_image_16](assets/1.理论_image_16.png)
- kd为折射比例
- ks为反射比例
...
**高光BRDF**
高光部分的BRDF如下：
![1.理论_image_17](assets/1.理论_image_17.png)
...
![325x187](assets/1.理论_image_18.png)
...
![436x32](assets/1.理论_image_24.png)

Schlick-GGX作为G项的效果可以参考下边这样：
![666x140](assets/1.理论_image_25.png)
...
![1.理论_image_26](assets/1.理论_image_26.png)
...
![1.理论_image_27](assets/1.理论_image_27.png)
- F<sub>0</sub>表示表面的反射率，它是利用Indices of Refraction（折射指数）IOR计算得出的
![267x256](assets/1.理论_image_28.png)
...
本篇我们列举一些常见材质：
![1.理论_image_29](assets/1.理论_image_29.png)
...
![475x59](assets/1.理论_image_30.png)
这个方程在数学上并不完全正确
上述Fresnel项中代表表面反射光的比率，也就是说F项隐含了Ks
所以最终的反射方程应该是：
![509x66](assets/1.理论_image_31.png)

## PBR Material
在实际的PBR流程中，所有参数都可以使用贴图来表示，类似下边这样：
![538x296](assets/1.理论_image_32.png)
- Albedo
    - 反照率，指定表面颜色或者基础反射率
...
![427x200](assets/1.理论_image_36.png)
