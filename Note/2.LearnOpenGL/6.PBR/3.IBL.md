...
![[assets/3.IBL_image_1.png]]
BRDF的漫反射kd和镜面反射ks是相互独立的，我们可以将它们拆分开：
![[assets/3.IBL_image_2.png]]
...
![[assets/3.IBL_image_6.png|329x137]]
![[assets/3.IBL_image_7.png|411x164]]
- R0 = 基础反射率
- θ夹角
- α = roughness
...
首先先列出漫反射的反射方程：
![[assets/3.IBL_image_10.png|269x63]]
我们知道漫反射的lambert项kd是常数（kd折射率，c颜色，π都是常数）
所以可以将常数系数分离出来：
![[assets/3.IBL_image_11.png|298x58]]
现在有关的就还有p和ωi了
...
![[assets/3.IBL_image_12.png|352x259]]
...
一个hdr图类似下边这样：
![[assets/3.IBL_image_13.png|471x241]]
...
![[assets/3.IBL_image_14.png|380x283]]
...
```
![[assets/3.IBL_image_15.png|624x460]]
...
![[assets/3.IBL_image_19.png|468x411]]
...
```
![[assets/3.IBL_image_20.png|512x448]]
...
我们显示回到镜面反射ks的反射方程：
![[assets/3.IBL_image_21.png|502x83]]
...
拆分后的结果如下：
![[assets/3.IBL_image_22.png|509x99]]
...
![[assets/3.IBL_image_23.png|394x157]]
...
![[assets/3.IBL_image_24.png|543x219]]
...
![[assets/3.IBL_image_28.png|390x214]]
...
![[assets/3.IBL_image_29.png|468x429]]
...
![[assets/3.IBL_image_30.png|317x277]]
...
##### 亮点
![[assets/3.IBL_image_31.png|353x296]]
...
我们直接看拆分后的公式：
![[assets/3.IBL_image_32.png|519x46]]
...
得到的结果类似下边这样：
![[assets/3.IBL_image_33.png|213x214]]
