...
![[assets/7.Bloom_image_1.png|595x170]]

它的核心思想是：提取出图像中亮度超过阈值的范围，进行模糊，然后叠加到原图
![[assets/7.Bloom_image_2.png|516x224]]
...
![[assets/7.Bloom_image_3.png|638x232]]
...
![[assets/7.Bloom_image_4.png|295x203]]
...
![[assets/7.Bloom_image_5.png|604x161]]

如果具体一点，采用下边这个5x5的kernel，就是下边这样：
将每列相加就得到了行的Kernel，将每行相加就得到了列的Kernel
![[assets/7.Bloom_image_6.png|654x263]]
...
![[assets/7.Bloom_image_7.gif|437x290]]
...
```
![[assets/7.Bloom_image_8.png|578x435]]
