...
RenderQuad();
```
效果类似下边这样![6.HDR_image_1](assets/6.HDR_image_1.png)
可以看到最亮的地方已经完全糊成一片了
...
我们这里看看之前笔者手动在unityShader中ToneMapping不同算法的效果![6.HDR_image_2](assets/6.HDR_image_2.png)
...
隧道尽头的灯光强度为50
![6.HDR_image_3](assets/6.HDR_image_3.png)

如果把尽头的灯光强度改为3，效果对比如下：
![6.HDR_image_4](assets/6.HDR_image_4.png)
