...
![[assets/8.Deferred Shading_image_1.png|377x203]]
...
一个GBuffer类似下图这样：
![[assets/8.Deferred Shading_image_3.png|453x336]]
或者你可以直接打开UE，一个场景的G-Buffer类似下边这样：
![[assets/8.Deferred Shading_image_4.png|528x306]]
...
![[assets/8.Deferred Shading_image_5.png|465x352]]
接下来我们使用这些数据进行光照计算
...
![[assets/8.Deferred Shading_image_6.png]]
...
```
![[assets/8.Deferred Shading_image_7.png]]

![[assets/8.Deferred Shading_image_8.png]]
## 4.更多光源
...
![[assets/8.Deferred Shading_image_9.png|341x58]]
...
这时衰减方程会是这样的：
![[assets/8.Deferred Shading_image_10.png|168x42]]
- I_Max = 光源最亮的颜色分类

我们继续解方程：
![[assets/8.Deferred Shading_image_11.png|412x236]]
到此为止，方程就表示为ax<sup>2</sup>+bx+c = 0 的方式了
求解如下：
![[assets/8.Deferred Shading_image_12.png|471x79]]
...
![[assets/8.Deferred Shading_image_13.png|642x217]]
