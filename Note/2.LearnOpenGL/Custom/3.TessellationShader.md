...
```
![[assets/3.TessellationShader_image_1.png|561x403]]
...
![[assets/3.TessellationShader_image_2.png|587x421]]
...
![[assets/3.TessellationShader_image_3.png|708x532]]
...
![[assets/3.TessellationShader_image_4.png|338x338]]
...
指定细分间隔的方法有三种：
- equal_spacing                       大小等边的细分![[assets/3.TessellationShader_image_5.gif]]
- fractional_odd_spacing         奇数个间隔，分长短段![[assets/3.TessellationShader_image_6.gif]]
- fractional_even_spacing        偶数个间隔，分长短段![[assets/3.TessellationShader_image_7.gif]]
...
比如下边不同细分等级的效果：
![[assets/3.TessellationShader_image_8.png|444x159]]
一但生成内环，外环就是基于每个外部细分级别生成最终的中间点
![[assets/3.TessellationShader_image_9.png|216x237]]
